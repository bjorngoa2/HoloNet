...
Source: https://learn.microsoft.com/en-us/dotnet/standard/design-guidelines/event
...
✔️ DO use [System.EventHandler<TEventArgs>](/en-us/dotnet/api/system.eventhandler-1) instead of manually creating new delegates to be used as event handlers.

✔️ CONSIDER using a subclass of [EventArgs](/en-us/dotnet/api/system.eventargs) as the event argument, unless you are absolutely sure the event will never need to carry any data to the event handling method, in which case you can use the `EventArgs` type directly.
...
Use [System.ComponentModel.CancelEventArgs](/en-us/dotnet/api/system.componentmodel.canceleventargs) or its subclass as the event argument to allow the end user to cancel events.
...
✔️ DO use [System.EventArgs](/en-us/dotnet/api/system.eventargs) or its subclass as the type of the second parameter of the event handler, and call it `e`.

...
Source: https://learn.microsoft.com/en-us/dotnet/standard/design-guidelines/names-of-namespaces
...
* **Application model namespaces**
  ...
  Namespaces belonging to a single application model are very often used together, but they are almost never used with namespaces of other application models. For example, the [System.Windows.Forms](/en-us/dotnet/api/system.windows.forms) namespace is very rarely used together with the [System.Web.UI](/en-us/dotnet/api/system.web.ui) namespace. The following is a list of well-known application model namespace groups:
  ...
  For example, do not add a type named `Page` to the [System.Web.UI.Adapters](/en-us/dotnet/api/system.web.ui.adapters) namespace, because the [System.Web.UI](/en-us/dotnet/api/system.web.ui) namespace already contains a type named `Page`.
...
* **Core namespaces**
  ...
  For example, never use `Stream` as a type name. It would conflict with [System.IO.Stream](/en-us/dotnet/api/system.io.stream), a very commonly used type.

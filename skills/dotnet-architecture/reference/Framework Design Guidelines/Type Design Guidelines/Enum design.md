...
Source: https://learn.microsoft.com/en-us/dotnet/standard/design-guidelines/enum
...
✔️ CONSIDER using [Int32](/en-us/dotnet/api/system.int32) (the default in most programming languages) as the underlying type of an enum unless any of the following is true:

* The enum is a flags enum and you have more than 32 flags, or expect to have more in the future.
* The underlying type needs to be different than [Int32](/en-us/dotnet/api/system.int32) for easier interoperability with unmanaged code expecting different-size enums.
...
❌ DO NOT extend [System.Enum](/en-us/dotnet/api/system.enum) directly.

[System.Enum](/en-us/dotnet/api/system.enum) is a special type used by the CLR to create user-defined enumerations. Most programming languages provide a programming element that gives you access to this functionality. For example, in C# the `enum` keyword is used to define an enumeration.

### Designing Flag Enums

✔️ DO apply the [System.FlagsAttribute](/en-us/dotnet/api/system.flagsattribute) to flag enums. Do not apply this attribute to simple enums.
...
Bitwise operations are an advanced concept and should not be required for simple tasks. [ReadWrite](/en-us/dotnet/api/system.io.fileaccess#system-io-fileaccess-readwrite) is an example of such a special value.

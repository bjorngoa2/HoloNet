...
Source: https://learn.microsoft.com/en-us/dotnet/standard/design-guidelines/type
...
[Abstract Class Design](abstract-class)  
[Static Class Design](static-class)  
[Interface Design](interface)  
[Struct Design](struct)  
[Enum Design](enum)  

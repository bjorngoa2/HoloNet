...
Source: https://learn.microsoft.com/en-us/dotnet/architecture/modern-web-apps-azure/common-client-side-web-technologies
...
For more information, see [Introduction to ASP.NET Core Blazor](/en-us/aspnet/core/blazor/).
...
>   [https://learn.microsoft.com/aspnet/core/client-side/less-sass-fa](/en-us/aspnet/core/client-side/less-sass-fa)
> * **Client-Side Development in ASP.NET Core**  
>   [https://learn.microsoft.com/aspnet/core/client-side/](/en-us/aspnet/core/client-side/)
> * **jQuery**  
>   <https://jquery.com/>
> * **Angular**  
>   <https://angular.io/>
...
[Previous](common-web-application-architectures)
[Next](develop-asp-net-core-mvc-apps)

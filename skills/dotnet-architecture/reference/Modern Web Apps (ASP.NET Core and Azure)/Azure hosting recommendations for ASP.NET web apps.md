...
Source: https://learn.microsoft.com/en-us/dotnet/architecture/modern-web-apps-azure/azure-hosting-recommendations-for-asp-net-web-apps
...
[Learn more about design patterns to consider when building microservice-based systems.](/en-us/azure/architecture/microservices/design/patterns)
...
[Learn more about Azure Dev Spaces](/en-us/azure/dev-spaces/about)
...
* Azure Basic Web Application Architecture  
  [https://learn.microsoft.com/azure/architecture/reference-architectures/app-service-web-app/basic-web-app](/en-us/azure/architecture/reference-architectures/app-service-web-app/basic-web-app)
* Design Patterns for Microservices  
  [https://learn.microsoft.com/azure/architecture/microservices/design/patterns](/en-us/azure/architecture/microservices/design/patterns)
* Azure Developer Guide  
  <https://azure.microsoft.com/campaigns/developer-guide/>
* Web Apps overview  
  [https://learn.microsoft.com/azure/app-service/app-service-web-overview](/en-us/azure/app-service/app-service-web-overview)
* Web App for Containers  
  <https://azure.microsoft.com/services/app-service/containers/>
* Introduction to Azure Kubernetes Service (AKS)  
  [https://learn.microsoft.com/azure/aks/intro-kubernetes](/en-us/azure/aks/intro-kubernetes)

[Previous](development-process-for-azure)

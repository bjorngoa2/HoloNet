...
Source: https://learn.microsoft.com/en-us/dotnet/architecture/modern-web-apps-azure/work-with-data-in-asp-net-core-apps
...
To work with EF Core, you need a subclass of [DbContext](/en-us/dotnet/api/microsoft.entityframeworkcore.dbcontext). This class holds properties representing collections of the entities your application will work with. The eShopOnWeb sample includes a `CatalogContext` with collections for items, brands, and types:
...
For more information, see [Buffering and Streaming](/en-us/ef/core/performance/efficient-querying#buffering-and-streaming).
...
It's a good idea to test your application while examining the actual database queries it makes. Under certain circumstances, EF Core may make many more queries or a more expensive query than is optimal for the application. One such problem is known as a [Cartesian Explosion](/en-us/ef/core/querying/single-split-queries#cartesian-explosion). The EF Core team makes available the [AsSplitQuery method](/en-us/ef/core/querying/single-split-queries#split-queries) as one of several ways to tune runtime behavior.
...
>
> * **EF Core Docs**
>   [https://learn.microsoft.com/ef/](/en-us/ef/)
> * **EF Core: Related Data**
>   [https://learn.microsoft.com/ef/core/querying/related-data](/en-us/ef/core/querying/related-data)
...
* Azure Cosmos DB Introduction
  [https://learn.microsoft.com/azure/cosmos-db/introduction](/en-us/azure/cosmos-db/introduction)
...
* Azure Storage Introduction
  [https://learn.microsoft.com/azure/storage/common/storage-introduction](/en-us/azure/storage/common/storage-introduction)
...
If the data or operations being performed are sensitive, be sure to review the section on security in the [previous chapter](develop-asp-net-core-mvc-apps) and protect your APIs against unauthorized access.
...
* Call a web API from ASP.NET Core Blazor
  [https://learn.microsoft.com/aspnet/core/blazor/call-web-api](/en-us/aspnet/core/blazor/call-web-api)

[Previous](develop-asp-net-core-mvc-apps)
[Next](test-asp-net-core-mvc-apps)

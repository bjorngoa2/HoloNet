...
As is the case with long methods as well, programmers usually �nd it mentally less taxing to
...
• Extract Class helps if part of the behavior of the large class can be spun off into a separate
component.
...
Payoff
• Refactoring of these classes spares developers from needing to remember a large number of
